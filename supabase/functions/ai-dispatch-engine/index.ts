...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`[ai-dispatch-engine] Request:`, JSON.stringify(body).slice(0, 200));

    // AI dispatch engine placeholder - requires OpenAI integration
    return new Response(JSON.stringify({
      success: true,
      suggestions: [],
      message: "AI dispatch engine is beschikbaar maar heeft meer data nodig voor suggesties.",
