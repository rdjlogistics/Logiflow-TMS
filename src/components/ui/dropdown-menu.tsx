...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "data-[state=open]:bg-primary/10 focus:bg-muted",
      "touch-manipulation",
      inset && "pl-8",
      className,
    )}
...
>(({ className, sideOffset = 8, collisionPadding = 16, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      "z-50 min-w-[8rem] overflow-auto rounded-xl",
      "max-h-[min(24rem,var(--radix-dropdown-menu-content-available-height,80dvh))]",
      "border border-border/50 bg-popover/95 backdrop-blur-xl",
      "p-1.5 text-popover-foreground",
      "shadow-[0_8px_32px_-8px_hsl(var(--foreground)/0.2)]",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      "relative flex cursor-default select-none items-center rounded-lg",
      "py-2.5 pl-8 pr-3 text-sm outline-none",
      "transition-colors duration-100",
      "touch-manipulation active:scale-[0.98]",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "focus:bg-muted",
