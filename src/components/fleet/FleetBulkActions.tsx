...
import {
  Power, PowerOff, Download, X, Wrench, Gauge,
} from 'lucide-react';
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-0.5">
              <ActionButton
                icon={Power}
                label="Activeren"
                tooltip="Geselecteerde voertuigen activeren"
                onClick={onActivate}
              />
              <ActionButton
                icon={PowerOff}
                label="Deactiveren"
                tooltip="Geselecteerde voertuigen uit dienst nemen"
            ...
            <div className="flex items-center gap-0.5">
              <ActionButton
                icon={Wrench}
                label="Onderhoud"
                tooltip="Onderhoud plannen voor selectie"
                onClick={onScheduleMaintenance}
              />
              <ActionButton
                icon={Gauge}
                label="KM-stand"
                tooltip="Kilometerstand bijwerken"
